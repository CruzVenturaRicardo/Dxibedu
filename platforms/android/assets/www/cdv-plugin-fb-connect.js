...
CDV.FB = {
  init: function(apiKey, fail) {
    ...
    }, (fail?fail:null), 'org.apache.cordova.facebook.ConnectPlugin', 'init', [apiKey]);
  },
  login: function(params, cb, fail) {
    ...
    cordova.exec(function(e) { // login
        ...
        if (cb) cb(e);
    }, (fail?fail:null), 'org.apache.cordova.facebook.ConnectPlugin', 'login', params.scope.split(',') );
  },
  logout: function(cb, fail) {
    cordova.exec(function(e) {
      ...
      if (cb) cb(e);
    }, (fail?fail:null), 'org.apache.cordova.facebook.ConnectPlugin', 'logout', []);
  },
  getLoginStatus: function(cb, fail) {
    cordova.exec(function(e) {
      if (cb) cb(e);
    }, (fail?fail:null), 'org.apache.cordova.facebook.ConnectPlugin', 'getLoginStatus', []);
  },
  dialog: function(params, cb, fail) {
    cordova.exec(function(e) { // login
      if (cb) cb(e);
                  }, (fail?fail:null), 'org.apache.cordova.facebook.ConnectPlugin', 'showDialog', [params] );
  }
};
